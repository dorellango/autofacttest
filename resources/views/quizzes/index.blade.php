...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <table class="w-full text-left table-collapse bg-gray-900 mb-6">
                <thead>
                ...
                <tbody class="align-baseline">
                    @foreach ($quizzes as $quiz)
                        <tr class="border-l border-gray-300">
                            <td class="p-2 border-t border-gray-300 font-mono text-gray-300 bg-gray-800 border-r">
                                {{ $quiz->user->name }}
                            </td>
                            <td class="p-2 border-t border-gray-300 font-mono text-gray-300 bg-gray-800 border-r">
                                {{ $quiz->suggestions }}
        ...
        <div class="mt-24 col-md-8">
            <div class="mb-16 border border-dashed border-gray-600 bg-gray-900 p-4">
                <answer-chart :labels="['Si', 'No', 'Más o Menos']"></answer-chart>
